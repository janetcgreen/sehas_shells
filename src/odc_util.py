...
mks['helium'] = {}
mks['helium']['q'] = 2*mks['e'] # charge
mks['helium']['m0'] = 4.002603*1.6605402e-27 # rest mass, kg
mks['helium']['Z'] = 4

mks['carbon'] = {}
mks['carbon']['q'] = 6*mks['e'] # charge
mks['carbon']['m0'] = 12.0107*1.6605402e-27 # rest mass, kg
mks['carbon']['Z'] = 12

mks['oxygen'] = {}
mks['oxygen']['q'] = 8*mks['e'] # charge
mks['oxygen']['m0'] = 15.99*1.6605402e-27
mks['oxygen']['Z'] = 16
...
def MeVtogamma(MeV,species):
    ...
    W = mks[species]['Z']*MeV*mks['MeV'] # Energy, Joules
...
def rigidity(MeV,species):
    ...
    :para
    m MeV: The energy in MeV
    :param species: right now either 'proton' or 'electron'
    :return:
    '''
    """
